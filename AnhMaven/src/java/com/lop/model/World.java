...
public class World {
    ...
    private World() {
        ...
        users.add(new User("huj", "111111", "Hugh Jackman", doctor));
        users.add(new User("ctu", "111111", "Channing Tatum", nurse));
        users.add(new User("batman", "111111", "Christiano", doctor));
        users.add(new User("superman", "111111", "Channing Tatum", doctor));
        users.add(new User("hulk", "111111", "ugly", nurse));
        users.add(new User("vampire", "111111", "blood seeker", nurse));

        users.add(new User("iHaveNoBoard", "111111", "Ihave Noboard", nurse));
        users.add(new User("meNoBoard", "111111", "Iamin Noboard", nurse));
